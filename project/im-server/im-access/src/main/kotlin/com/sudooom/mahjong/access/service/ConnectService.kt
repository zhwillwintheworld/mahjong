...
class ConnectService(
    ...
    suspend fun message(messages: Flow<ByteArray>, requester: RSocketRequester): Flow<ByteArray> {
        val session = sessionManager.getSession(requester) ?: throw IllegalArgumentException("User not found")
